...
추천 가중치는 졸업생 홀드아웃 343케이스로 실측 검증했다 — 현행 40/25/20/15는 재현율 최적값이 아니라(R@8 0.391, 구 그리드 튜닝값 0.407) **강추 버킷의 정밀도**를 택한 값이다(강추 실수강률 39.6% vs 34.0%). 근거: [`docs/scoring_rationale.md`](./docs/scoring_rationale.md)
