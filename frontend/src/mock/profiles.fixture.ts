// 데모 프로필 A~D. 각 프로필이 학생 데이터(전공/평점) + 이수과목 + 분석 결과를 보유.
// 학생 A = 현재 내 정보 (김재원 · 1전공 아트&테크놀로지 · 2전공 컴퓨터공학 · 평점 3.24).
...
export const profiles: DemoProfile[] = [
  ...
  { id: "B", label: "학생 B", available: false, primaryMajor: "", extraMajors: [], gpa: null, takenCourses: [], dashboard: emptyDashboard("학생 B") },
  { id: "C", label: "학생 C", available: false, primaryMajor: "", extraMajors: [], gpa: null, takenCourses: [], dashboard: emptyDashboard("학생 C") },
  { id: "D", label: "학생 D", available: false, primaryMajor: "", extraMajors: [], gpa: null, takenCourses: [], dashboard: emptyDashboard("학생 D") },
];
